...
### Languages
[![My Skills](https://skillicons.dev/icons?i=cpp,c,kotlin,java,php,py,r,ts,js)](https://skillicons.dev)

### Frameworks, etc.
[![My Skills](https://skillicons.dev/icons?i=pytorch,raspberrypi,cmake,flutter,arduino,git,docker,nginx,nodejs,vscode,visualstudio,unity)](https://skillicons.dev)
